...
_chi_sq_table = {0.1:2.70554345,
                 ...
                 0.000001:23.92813,
                 0.0000001:28.37399}
with open('{cdir}/stop_words.txt'.format(cdir=curdir)) as fin:
    _stop_words = [v.strip() for v in fin.readlines()]
...
def nested_sig_bigrams(iter_generator, update_fun, sig_test, min_):
    ...
    while (len(terms) > 0):
        ...
        for v in terms:
            sig_bigrams = counts.sig_bigrams(v, sig_test, min_)
