...
from . import turbotopics as tt
# import sys
# from pprint import *

# def main(corpus, pvalue, use_perm, out_filename, min_count=5,
#          min_bigram_count=5, min_char_count=3):
def work(corpus, pvalue, use_perm, min_count=5,
         min_bigram_count=5, min_char_count=3):
    ...
    return {term: count for (term, count) in sorted(cnts.marg.items(), key=lambda x:-x[1])}
